const CACHE = 'restart-v13.10';
const FILES = [
  './','index.html','manifest.webmanifest','icon-192.png','icon-512.png','coin-icon.png',
  'css/app.css?v=13.10','js/supabase-config.js?v=13.10','js/cloud-settings.js?v=13.10',
  'js/auth.js?v=13.10','js/app.js?v=13.10','js/avatar-v123.js?v=13.10','js/square-v13.js?v=13.10','js/feedback-v133.js?v=13.10','js/admin-v134.js?v=13.10','js/wallet-v135.js?v=13.10','js/daily-v135.js?v=13.10',
