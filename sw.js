const CACHE = 'restart-v13.17';
const FILES = [
  './','index.html','manifest.webmanifest','icon-192.png','icon-512.png','coin-icon.png',
  'css/app.css?v=13.17','js/supabase-config.js?v=13.17','js/cloud-settings.js?v=13.17',
  'js/auth.js?v=13.17','js/app.js?v=13.17','js/avatar-v123.js?v=13.17','js/square-v13.js?v=13.17','js/feedback-v133.js?v=13.17','js/admin-v134.js?v=13.17','js/square-chat-v1315.js?v=13.17','js/wallet-v135.js?v=13.17','js/daily-v135.js?v=13.17',
