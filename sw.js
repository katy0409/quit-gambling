const CACHE = 'restart-v13.25-male-outfit-preview-1';
const FILES = [
  './','index.html','manifest.webmanifest','icon-192.png','icon-512.png','coin-icon.png',
  'css/app.css?v=13.25.1','js/supabase-config.js?v=13.25','js/cloud-settings.js?v=13.25',
  'js/auth.js?v=13.25','js/sos-quotes.js?v=13.25','js/app.js?v=13.25.3','js/avatar-v123.js?v=13.25.1','js/square-v13.js?v=13.25.2','js/feedback-v133.js?v=13.25','js/admin-v134.js?v=13.25','js/square-chat-v1315.js?v=13.25','js/wallet-v135.js?v=13.25','js/daily-v135.js?v=13.25',
  ...
  'assets/avatar/top/male-top-1/male-top-1_front.png',
