const CACHE = 'restart-v13.2';
const FILES = [
  './','index.html','manifest.webmanifest','icon-192.png','icon-512.png','coin-icon.png',
  'css/app.css?v=13.2','js/supabase-config.js?v=13.2','js/cloud-settings.js?v=13.2',
  'js/auth.js?v=13.2','js/app.js?v=13.2','js/avatar-v123.js?v=13.2','js/square-v13.js?v=13.2',
