...
(function () {
  ...
  window.renderCharacterChoices = function () {
    ...
    const males = (window.STARTER_CHARACTERS || []).filter(char => char.gender === 'male');
    const females = (window.STARTER_CHARACTERS || []).filter(char => char.gender === 'female');
    box.innerHTML = `
