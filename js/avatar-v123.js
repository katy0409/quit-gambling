...
(function () {
  ...
  const ASSETS = {
    ...
    shopTopMale1: {front:`${ASSET_ROOT}/top/male-top-1/male-top-1_front.png`,left:`${ASSET_ROOT}/top/male-top-1/male-top-1_left.png`,right:`${ASSET_ROOT}/top/male-top-1/male-top-1_right.png`},
  ...
  function stage(viewport) {
    ...
    if (viewport.headCrop) {
      ...
      // The male and female starter artwork do not share the same visible-pixel
      // center on the 1024px artboard. Use gender-specific camera crops instead
      // of a fixed CSS-pixel nudge, so both remain centered at every card size.
      crop = viewport.gender === 'female'
        ? { x: 253, y: 205, width: 524, height: 790 }
        : { x: 229, y: 205, width: 524, height: 790 };
